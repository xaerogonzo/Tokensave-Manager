...
from helpers.llm import _is_auth_error, _iter_json_lines
# _call_llm, _build_llm_prompt, _call_anthropic, _call_openai_compat,
# _iter_sse_events also live in helpers.llm — used by extracted dialogs
# (ai_code_review.py) and helpers.commit_messages, not by the monolith.
...
# AICodeReviewDialog moved to src/dialogs/ai_code_review.py (Round 4 Phase C.1 — cfg: ManagerConfig param added)
